...
def mock_openai_for_tests():
    ...
    with patch('chainchat.chat.ConversationChain') as mock_conv_chain, \
        ...
        def create_mock_conv_chain(*args, **kwargs):
            ...
            def mock_predict(input):
                ...
                if memory and hasattr(memory, 'chat_memory'):
                    ...
                    memory.chat_memory.messages.append(AIMessage(content="Hello! I'm an AI assistant. I can help you with questions and have conversations."))
